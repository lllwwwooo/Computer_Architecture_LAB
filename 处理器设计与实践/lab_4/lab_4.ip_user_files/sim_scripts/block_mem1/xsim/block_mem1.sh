...
#
# Script generated by Vivado on Tue Sep 05 15:37:56 +0800 2023
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : block_mem1.sh
...
#
# Usage        : block_mem1.sh
#                block_mem1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                block_mem1.sh [-reset_run]
#                block_mem1.sh [-reset_log]
#                block_mem1.sh [-help]
#
...
# script info
echo -e "block_mem1.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./block_mem1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot block_mem1 xil_defaultlib.block_mem1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim block_mem1 -key {Behavioral:sim_1:Functional:block_mem1} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/ProgramFiles/vivado/Vivado/2023.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb block_mem1.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./block_mem1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: block_mem1.sh [-help]\n\
Usage: block_mem1.sh [-step]\n\
Usage: block_mem1.sh [-lib_map_path]\n\
Usage: block_mem1.sh [-reset_run]\n\
Usage: block_mem1.sh [-reset_log]\n\
Usage: block_mem1.sh [-keep_index]\n\
Usage: block_mem1.sh [-noclean_files]\n\n\
