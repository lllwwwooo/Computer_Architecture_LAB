...
#                script (type 'block_mem1.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.block_mem1 xil_defaultlib.glbl -o block_mem1_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./block_mem1_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key block_mem1_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc block_mem1_simv.daidir vcs_lib c.obj)
